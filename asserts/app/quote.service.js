...
(function (appName) {
    ...
    const sampleQuotes = [
        ...
        {
            'line': 'It always takes longer than you expect, even when you take into account Hofstadters Law.',
            'author': 'Hofstadters Law'
        },
        {
        ...
        {
            'line': 'Nine people canoˀt make a baby in a month.',
            'author': 'Fred Brooks'
        },
        {
    ...
    appName.QuoteService = Class({
        constructor: function QuoteServiceConstructor() {
